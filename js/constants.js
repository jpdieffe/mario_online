...
export const JUMP_VEL = -9.0;       // initial jump velocity
export const JUMP_HOLD_FRAMES = 14;  // frames jump force is extended
export const GRAVITY_RISE = 0.20;    // gravity while ascending (floaty)
export const GRAVITY_FALL = 0.45;    // gravity while descending (snappy)
